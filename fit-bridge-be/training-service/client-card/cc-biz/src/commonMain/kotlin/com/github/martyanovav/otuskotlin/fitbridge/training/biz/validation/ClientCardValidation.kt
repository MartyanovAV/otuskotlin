...
fun ICorChainDsl<ClientCardContext>.prepareClientCardValidation(
    title: String,
    ...
    worker {
        ...
        handle {
            ...
            ctx.clientCardFilterValidating =
                ctx.clientCardFilter.deepCopy().apply {
                    searchString = searchString.trim()
                }
        }
    }

fun ICorChainDsl<ClientCardContext>.validateClientCardIdNotEmpty(title: String) =
    validationWorker(
        title = title,
        field = "id",
        violationCode = "empty",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardIdFormat(title: String) =
    validationWorker(
        title = title,
        field = "id",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardDisplayNameNotEmpty(title: String) =
    validationWorker(
        title = title,
        field = "displayName",
        violationCode = "empty",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardDisplayNameMaxLength(title: String) =
    validationWorker(
        title = title,
        field = "displayName",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardDisplayNameHasContent(title: String) =
    validationWorker(
        title = title,
        field = "displayName",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardNoteMaxLength(title: String) =
    validationWorker(
        title = title,
        field = "note",
        violationCode = "tooLong",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardLockNotEmpty(title: String) =
    validationWorker(
        title = title,
        field = "lock",
        violationCode = "empty",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardLockFormat(title: String) =
    validationWorker(
        title = title,
        field = "lock",
        violationCode = "badFormat",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardSearchStringLength(title: String) =
    validationWorker(
        title = title,
        field = "searchString",
        violationCode = "tooLong",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardFilterStatus(title: String) =
    validationWorker(
        title = title,
        field = "status",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardPageNumber(title: String) =
    validationWorker(
        title = title,
        field = "pageNumber",
...
fun ICorChainDsl<ClientCardContext>.validateClientCardPageSize(title: String) =
    validationWorker(
        title = title,
        field = "pageSize",
        violationCode = "outOfRange",
