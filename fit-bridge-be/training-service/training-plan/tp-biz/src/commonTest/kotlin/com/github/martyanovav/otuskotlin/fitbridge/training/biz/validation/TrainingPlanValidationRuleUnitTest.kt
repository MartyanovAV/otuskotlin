...
class TrainingPlanValidationRuleUnitTest {
    @Test
    fun `training plan id must not be empty`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `training plan id must have valid format`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `client card id must not be empty`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `client card id must have valid format`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `title must satisfy minimum length`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `title must satisfy maximum length`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `title must contain letters`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `plan items must not be empty`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `plan item count must satisfy maximum`() =
        runTest {
    ...
    @Test
    fun `plan item nesting must satisfy maximum depth`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `plan item ids must be unique`() =
        runTest {
    ...
    @Test
    fun `plan item title must be valid`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `plan item description must satisfy maximum length`() =
        runTest {
            assertRule(
                plan =
                    validPlan(
    ...
    @Test
    fun `circuit must contain an item`() =
        runTest {
            assertRule(
                plan =
                    validPlan(
    ...
    @Test
    fun `superset must contain at least two items`() =
        runTest {
            assertRule(
                plan =
                    validPlan(
    ...
    @Test
    fun `circuit rounds must be positive`() =
        runTest {
            assertRule(
                plan =
                    validPlan(
    ...
    @Test
    fun `exercise set duration must not be negative`() =
        runTest {
            assertRule(
                plan =
                    validPlan(
    ...
    @Test
    fun `exercise rest must not be negative`() =
        runTest {
            assertRule(
                plan =
                    validPlan(
    ...
    @Test
    fun `circuit rest must not be negative`() =
        runTest {
            assertRule(
                plan =
                    validPlan(
    ...
    @Test
    fun `superset rest must not be negative`() =
        runTest {
            assertRule(
                plan =
                    validPlan(
    ...
    @Test
    fun `filter client card id must have valid format`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `search string must satisfy maximum length`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `page number must be positive`() =
        runTest {
            assertRule(
    ...
    @Test
    fun `page size must be within supported range`() =
        runTest {
            assertRule(
    ...
    private suspend fun assertRule(
        ...
        expectedCode: String,
        rule: ICorChainDsl<TrainingPlanContext>.() -> Unit,
    ) {
        val context =
            TrainingPlanContext(
                state = State.RUNNING,
    ...
    private fun nestedCircuit(depth: Int): PlanItem =
        if (depth == 1) {
