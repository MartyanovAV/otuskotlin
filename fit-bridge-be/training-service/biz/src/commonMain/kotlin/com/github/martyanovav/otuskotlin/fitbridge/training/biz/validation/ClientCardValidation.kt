...
fun ICorChainDsl<IFBContext>.prepareClientCardFilterValidation(title: String) =
    worker {
        this.title = title
        on { this is ClientCardContext }
        handle {
...
fun ICorChainDsl<IFBContext>.validateClientCardIdNotEmpty(title: String) =
    validationWorker(
        title = title,
        field = "id",
        violationCode = "empty",
...
fun ICorChainDsl<IFBContext>.validateClientCardIdFormat(title: String) =
    validationWorker(
        title = title,
        field = "id",
...
fun ICorChainDsl<IFBContext>.validateClientCardDisplayNameNotEmpty(title: String) =
    validationWorker(
        title = title,
        field = "displayName",
        violationCode = "empty",
...
fun ICorChainDsl<IFBContext>.validateClientCardDisplayNameMaxLength(title: String) =
    validationWorker(
        title = title,
        field = "displayName",
...
fun ICorChainDsl<IFBContext>.validateClientCardDisplayNameHasContent(title: String) =
    validationWorker(
        title = title,
        field = "displayName",
...
fun ICorChainDsl<IFBContext>.validateClientCardNoteMaxLength(title: String) =
    validationWorker(
        title = title,
        field = "note",
        violationCode = "tooLong",
...
fun ICorChainDsl<IFBContext>.validateClientCardLockNotEmpty(title: String) =
    validationWorker(
        title = title,
        field = "lock",
        violationCode = "empty",
...
fun ICorChainDsl<IFBContext>.validateClientCardSearchStringLength(title: String) =
    validationWorker(
        title = title,
        field = "searchString",
        violationCode = "tooLong",
...
fun ICorChainDsl<IFBContext>.validateClientCardFilterStatus(title: String) =
    validationWorker(
        title = title,
        field = "status",
...
fun ICorChainDsl<IFBContext>.validateClientCardPageNumber(title: String) =
    validationWorker(
        title = title,
        field = "pageNumber",
...
fun ICorChainDsl<IFBContext>.validateClientCardPageSize(title: String) =
    validationWorker(
        title = title,
        field = "pageSize",
        violationCode = "outOfRange",
...
fun ICorChainDsl<IFBContext>.finishClientCardValidation(title: String) =
    worker {
        this.title = title
...
fun ICorChainDsl<IFBContext>.finishClientCardFilterValidation(title: String) =
    worker {
        this.title = title
        on { state == State.RUNNING && this is ClientCardContext }
        handle {
