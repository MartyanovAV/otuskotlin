...
class TrainingPlanValidationTest {
    ...
    @Test
    fun validCreateRequestIsDeepCopiedNormalizedAndValidated() = runTest {
        val request = TrainingPlan(
    ...
    @Test
    fun itemIdsMustBeUuidsAndUnique() = runTest {
    ...
    @Test
    fun nestedStructureAndNumericRangesAreValidated() = runTest {
        val ctx = createContext(
            CircuitItem(
                id = "00000000-0000-0000-0000-000000000301",
                title = "Круг",
    ...
    @Test
    fun itemCountAndNestingDepthAreLimited() = runTest {
        val tooManyItems = (1..201).map { index ->
            ExerciseItem(
        ...
        var nestedItem: PlanItem = ExerciseItem(
            id = "00000000-0000-0000-0000-000000000306",
            title = "Упражнение",
        )
        for (index in 5 downTo 1) {
            nestedItem = CircuitItem(
                id = "00000000-0000-0000-0000-${index.toString().padStart(12, '0')}",
                title = "Круг $index",
    ...
    private fun createContext(vararg items: PlanItem) = TrainingPlanContext(
        command = TrainingPlanCommand.CREATE,
        workMode = WorkMode.TEST,
        trainingPlanRequest = TrainingPlan(
            clientCardId = ClientCardId("client-1"),
