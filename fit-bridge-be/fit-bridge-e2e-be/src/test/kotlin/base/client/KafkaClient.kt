package com.github.martyanovav.otuskotlin.fitbridge.e2e.be.base.client
...
import com.github.martyanovav.otuskotlin.fitbridge.e2e.be.base.DockerCompose
...
class KafkaClient(dockerCompose: DockerCompose) : Client {
    ...
    private val consumer by lazy {
        KafkaConsumer<String, String>(
            ...
            it.subscribe(versions.map { "fitbridge-out-$it" })
        }
    }
    ...
    override suspend fun sendAndReceive(version: String, path: String, request: String): String {
        ...
        counter += 1
        producer.send(ProducerRecord("fitbridge-in-$version", "test-$counter", request)).get()
