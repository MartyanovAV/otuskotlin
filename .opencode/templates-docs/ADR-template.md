# TARGET DIRECTORY: docs/03-architecture/ADR/
# TARGET FILENAME: ADR-[NNN]-[decision_title].md (e.g., ADR-001-use-pg-repo.md)
# NEXT NUMBER: Sequential from glob(\"docs/03-architecture/ADR/ADR-*.md\" | wc -l +1)

# ADR-[NNN]: [Тема решения]

## Context

Implements [BR-NNN](../../01-business/BR/BR-NNN.md).
[Краткое описание проблемы для решения]

## Comparison

Comparing candidates against [BR-NNN](../../01-business/BR/BR-NNN.md):
