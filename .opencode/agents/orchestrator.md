...
Gate 2 Reject:
- Изменение бизнес-требований -> возвращай Product Owner (затем Architect, затем Executor)
- Техническая/архитектурная ошибка -> возвращай Architect
- Ошибка в коде (не проходят тесты) -> возвращай Executor

Gate 3 Reject (не пройдено ревью):
- Возвращай задачу к нужному этапу по твоему решению (обычно Executor для исправления багов или Architect для пересмотра решения).
