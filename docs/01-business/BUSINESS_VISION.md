...
Сокращённый MVP проверяет только первый рабочий цикл: тренер подключает клиента, назначает простой план, клиент отмечает выполнение, тренер видит историю и статусы выполнения. Аналитика, замеры, биллинг и multi-specialist остаются расширением после Gate 1.
...
- activation rate тренеров (1 клиент + 1 план в 7 дней) ≥ 55%;
- доля подключённых клиентов с первой отметкой выполнения ≥ 50%;
- qualitative willingness-to-pay: ≥ 5 пилотных тренеров подтверждают готовность платить после критического пути.
