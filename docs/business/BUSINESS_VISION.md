...
Downside/base/upside сценарии соответствуют траектории 750 / 1 000 / 1 200 платящих аккаунтов тренеров/команд к концу 3-го года при blended ARPU около ₽2 490/мес.
...
| Период | Платящие аккаунты (base-case) | Blended ARPU/мес | ARR / годовая экстраполяция |
|---|---:|---:|---:|
