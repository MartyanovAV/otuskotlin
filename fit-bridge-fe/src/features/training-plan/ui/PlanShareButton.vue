...
<template>
  <div class="relative inline-block text-left" ref="containerRef">
    ...
    <div
      v-if="isOpen"
      :class="[
        'absolute w-64 rounded-xl border border-border bg-surface p-1.5 shadow-xl z-popover animate-in fade-in zoom-in-95 duration-100',
        placementClasses,
      ]"
      @click.stop
    >
      <div
        class="px-2.5 py-1.5 text-[11px] font-semibold text-text-muted uppercase tracking-wider border-b border-border/50 mb-1"
      >
      ...
      >
        <div
          class="w-6 h-6 rounded-md bg-[#0077FF]/15 text-[#0077FF] flex items-center justify-center shrink-0"
        >
          <!-- VK icon -->
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex-1">
          <div class="font-semibold text-xs text-text-main group-hover:text-[#0077FF]">
            ВКонтакте (VK)
          </div>
      ...
      >
        <div
          class="w-6 h-6 rounded-md bg-[#229ED9]/15 text-[#229ED9] flex items-center justify-center shrink-0"
        >
          <!-- Telegram icon -->
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex-1">
          <div class="font-semibold text-xs text-text-main group-hover:text-[#229ED9]">
            Telegram
          </div>
      ...
      >
        <div
          class="w-6 h-6 rounded-md bg-[#25D366]/15 text-[#25D366] flex items-center justify-center shrink-0"
        >
          <!-- WhatsApp icon -->
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex-1">
          <div class="font-semibold text-xs text-text-main group-hover:text-[#25D366]">
            WhatsApp
          </div>
      ...
      >
        <div
          class="w-6 h-6 rounded-md bg-surface-3 text-text-muted flex items-center justify-center shrink-0"
        >
          <svg
            v-if="!isCopied"
            xmlns="http://www.w3.org/2000/svg"
