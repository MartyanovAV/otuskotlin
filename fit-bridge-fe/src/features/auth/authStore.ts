      ...
      if (authenticated) {
        try {
          ...
          userProfile.value = {
            ...
            firstName: (keycloak.idTokenParsed?.given_name ?? keycloak.tokenParsed?.given_name) as
              string | undefined,
            lastName: (keycloak.idTokenParsed?.family_name ?? keycloak.tokenParsed?.family_name) as
              string | undefined,
            email: (keycloak.idTokenParsed?.email ?? keycloak.tokenParsed?.email) as
              string | undefined,
          }
        }
